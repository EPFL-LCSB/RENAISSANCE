...
def setcpxterminate(*args):
  return _pycplex_platform.setcpxterminate(*args)
setcpxterminate = _pycplex_platform.setcpxterminate

def unset_cpx_terminator():
  return _pycplex_platform.unset_cpx_terminator()
unset_cpx_terminator = _pycplex_platform.unset_cpx_terminator

def set_cpx_terminator():
  return _pycplex_platform.set_cpx_terminator()
set_cpx_terminator = _pycplex_platform.set_cpx_terminator
